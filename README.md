...
5. Open Cura.
6. Remove the bed and nozzle temperature setters and the purge line gcode in the start gcode or, alternatively, use the start gcode below these steps (for QIDI I-Fast only). 
